  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-3">
        {/* <button
          type="button"
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-brand-black text-gray-900 dark:text-white font-semibold text-sm hover:border-brand-black dark:hover:border-brand-accent hover:shadow-md transition-all"
        >
          <span className="flex items-center justify-center w-6 h-6 rounded-full bg-white">
            <span className="text-lg leading-none font-bold text-[#4285F4]">G</span>
          </span>
      ...
      <div className="flex items-center justify-between">
        <label className="flex items-center gap-2 cursor-pointer group">
          <input
            ...
            className="w-4 h-4 text-brand-black dark:text-brand-accent border-gray-300 dark:border-white/20 rounded focus:ring-2 focus:ring-brand-accent focus:ring-offset-0"
          />
        ...
        <Link
          ...
          className="text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-brand-black dark:hover:text-brand-accent transition-colors"
        >
          Forgot password?
        </Link>
      </div>
